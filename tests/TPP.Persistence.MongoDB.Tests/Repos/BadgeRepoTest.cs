...
namespace TPP.Persistence.MongoDB.Tests.Repos
{
    ...
    public class BadgeRepoTest : MongoTestBase
    {
        ...
        public async Task insert_then_read_are_equal()
        {
            ...
            // when
            Badge badge = await badgeRepo.AddBadge(null, PkmnSpecies.OfId("16"), Badge.BadgeSource.ManualCreation, null, false);
        ...
        public async Task insert_sets_current_timestamp_as_creation_date()
        {
            ...
            Badge badge = await badgeRepo.AddBadge(null, PkmnSpecies.OfId("16"), Badge.BadgeSource.ManualCreation, null, false);
            Assert.That(createdAt, Is.EqualTo(badge.CreatedAt));
        }
        ...
        public async Task has_expected_bson_datatypes()
        {
            ...
            Badge badge = await badgeRepo.AddBadge(null, randomSpecies, Badge.BadgeSource.RunCaught, null, false);
        ...
        public async Task can_find_by_user()
        {
            ...
            // given
            Badge badgeUserA1 = await badgeRepo.AddBadge("userA", PkmnSpecies.OfId("1"), Badge.BadgeSource.Pinball, null, false);
            Badge badgeUserA2 = await badgeRepo.AddBadge("userA", PkmnSpecies.OfId("2"), Badge.BadgeSource.Pinball, null, false);
            Badge badgeUserB = await badgeRepo.AddBadge("userB", PkmnSpecies.OfId("3"), Badge.BadgeSource.Pinball, null, false);
            Badge badgeNobody = await badgeRepo.AddBadge(null, PkmnSpecies.OfId("4"), Badge.BadgeSource.Pinball, null, false);
        ...
        public async Task can_count_by_user_and_species()
        {
            IBadgeRepo badgeRepo = CreateBadgeRepo();
            // given
            await badgeRepo.AddBadge("user", PkmnSpecies.OfId("2"), Badge.BadgeSource.Pinball, null, false);
            await badgeRepo.AddBadge("user", PkmnSpecies.OfId("3"), Badge.BadgeSource.Pinball, null, false);
            await badgeRepo.AddBadge("user", PkmnSpecies.OfId("3"), Badge.BadgeSource.Pinball, null, false);
            await badgeRepo.AddBadge("user", PkmnSpecies.OfId("3"), Badge.BadgeSource.Pinball, null, false);
            await badgeRepo.AddBadge("userOther", PkmnSpecies.OfId("1"), Badge.BadgeSource.Pinball, null, false);
            await badgeRepo.AddBadge("userOther", PkmnSpecies.OfId("2"), Badge.BadgeSource.Pinball, null, false);
            await badgeRepo.AddBadge("userOther", PkmnSpecies.OfId("3"), Badge.BadgeSource.Pinball, null, false);
        ...
        {
            IBadgeRepo badgeRepo = CreateBadgeRepo();
            Badge badge = await badgeRepo.AddBadge("user", PkmnSpecies.OfId("1"), Badge.BadgeSource.Pinball, null, false);

            Badge forSale = await badgeRepo.SetBadgeSellPrice(badge, 10);

            Assert.That(forSale.SellPrice, Is.EqualTo(10));
        }
        ...
        public async Task FindAllForSaleByCustom_only_returns_badges_for_sale()
        {
            ...
            Badge notForSale = await badgeRepo.AddBadge("user", species, Badge.BadgeSource.Pinball, null, false);
            await badgeRepo.AddBadge("user", species, Badge.BadgeSource.Pinball, null, false);
            ...
            Assert.That(saleList, Is.EqualTo(new List<Badge>() { forSale }));
        }
        ...
        public async Task can_handle_null_shiny_fields()
        {
            ...
            Assert.That(b.Shiny, Is.EqualTo(false));
        ...
        private class TransferBadge : MongoTestBase
        {
            ...
            public async Task returns_updated_badge_object()
            {
                ...
                Badge badge = await badgeRepo.AddBadge(
                    "user", PkmnSpecies.OfId("1"), Badge.BadgeSource.ManualCreation, null, false);
                ...
                Assert.That(updatedBadges[0].Form, Is.EqualTo(badge.Form));
            }
            ...
            public async Task triggers_species_lost_event()
            {
                ...
                PkmnSpecies species = PkmnSpecies.OfId("1");
                Badge badge1 = await badgeRepo.AddBadge("user", species, Badge.BadgeSource.ManualCreation, null, false);
                Badge badge2 = await badgeRepo.AddBadge("user", species, Badge.BadgeSource.ManualCreation, null, false);
        ...
        private class BadgeStats : MongoTestBase
        {
            ...
            public async Task ignore_lapsed_for_rarity_counts()
            {
                ...
                await badgeRepo.AddBadge("user", species, Badge.BadgeSource.Pinball, null, false, tBeforeUpdateLapsed);
                await badgeRepo.AddBadge("user", species, Badge.BadgeSource.Pinball, null, false, tBeforeUpdateConsidered);
                await badgeRepo.AddBadge("user", species, Badge.BadgeSource.Pinball, null, false, tUpdate);
                await badgeRepo.AddBadge("user", species, Badge.BadgeSource.Pinball, null, false, tNow);
            ...
            public async Task ignore_destroyed_for_regular_count()
            {
                ...
                await badgeRepo.AddBadge(null, species, Badge.BadgeSource.Pinball, null, false);
            ...
            public async Task ignore_unnatural_sources_for_generated_count()
            {
                ...
                await badgeRepo.AddBadge("user", species, Badge.BadgeSource.Transmutation, null, false);
            ...
            public async Task incorporate_source_and_existence_in_rarity()
            {
                ...
                await badgeRepo.AddBadge("user", species1, Badge.BadgeSource.Pinball, null, false);
                await badgeRepo.AddBadge("user", species1, Badge.BadgeSource.Transmutation, null, false);

                await badgeRepo.AddBadge("user", species2, Badge.BadgeSource.Pinball, null, false);
                await badgeRepo.AddBadge("user", species2, Badge.BadgeSource.Transmutation, null, false);
                await badgeRepo.AddBadge("user", species2, Badge.BadgeSource.Transmutation, null, false);
                await badgeRepo.AddBadge(null, species2, Badge.BadgeSource.Transmutation, null, false);

                await badgeRepo.AddBadge(null, species3, Badge.BadgeSource.Pinball, null, false);
                await badgeRepo.AddBadge("user", species3, Badge.BadgeSource.Pinball, null, false);
                await badgeRepo.AddBadge("user", species3, Badge.BadgeSource.Transmutation, null, false);
