...
namespace Core
{
    public ref struct Utf8JsonStreamReader
    {
        ...
        private void MoveNext()
        {
            ...
            _jsonReader =
                new Utf8JsonReader(
                    new ReadOnlySequence<byte>(_firstSegment, _firstSegmentStartIndex, _lastSegment,
                        _lastSegmentEndIndex), _isFinalBlock, _jsonReader.CurrentState);
        }
        ...
        public T? Deserialize<T>(JsonSerializerOptions? options = null)
        {
            ...
            var newJsonReader =
                new Utf8JsonReader(
                    new ReadOnlySequence<byte>(firstSegment!, firstSegmentStartIndex, _lastSegment!,
