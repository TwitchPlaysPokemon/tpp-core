...
namespace TPP.Core
{
    ...
    public record SubscriptionGiftInfo(
        User? Gifter, SubscriptionTier Tier, int NumGiftedMonths, bool IsAnonymous);
    ...
    public class SubscriptionProcessor : ISubscriptionProcessor
    {
            ...
            SubscriptionGiftInfo subscriptionGiftInfo)
        {
            ...
            int rewardTokens = subscriptionGiftInfo.NumGiftedMonths * subscriptionGiftInfo.Tier.ToRank() * tokensPerRank;
